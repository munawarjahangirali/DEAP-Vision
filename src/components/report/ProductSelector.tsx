...
const ProductSelector: React.FC<ProductSelectorProps> = ({ onSubmit,setFilters,setPage }) => {
    ...
    // const { data: zoneOptions = [], error: zoneError } = useQuery({ queryKey: ['zones'], queryFn: fetchZones });
    // const { data: siteOptions = [], error: siteError } = useQuery({ queryKey: ['sites'], queryFn: fetchSites });
    // const { data: typeOptions = [], error: typeError } = useQuery({ queryKey: ['types'], queryFn: fetchTypes });
    ...
    // if (typeError) {
    //     console.error('Failed to fetch types:', typeError);
    // }
